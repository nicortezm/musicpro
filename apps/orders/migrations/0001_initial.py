    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_dpto', models.CharField(blank=True, max_length=10)),
                ('comentarios', models.CharField(blank=True, max_length=100)),
                ('order_total', models.FloatField()),
                ('descuento', models.FloatField()),
                ('status', models.CharField(choices=[('Nueva', 'Nueva'), ('Aceptada', 'Aceptada'), ('Completada', 'Completada'), ('Cancelada', 'Cancelada')], default='New', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('variations', models.ManyToManyField(blank=True, to='tienda.Variation')),
            ],
        ),
        migrations.AddField(
            model_name='order',
